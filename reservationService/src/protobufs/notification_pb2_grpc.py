...
class NotificationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateNotification = channel.unary_unary(
                '/notificationPackage.NotificationService/CreateNotification',
        ...
        self.UpdateNotification = channel.unary_unary(
                '/notificationPackage.NotificationService/UpdateNotification',
                request_serializer=notification__pb2.GetNotificationRequest.SerializeToString,
                response_deserializer=notification__pb2.NotificationResponse.FromString,
                _registered_method=True)
        self.DeleteNotification = channel.unary_unary(
                '/notificationPackage.NotificationService/DeleteNotification',
                request_serializer=notification__pb2.GetNotificationRequest.SerializeToString,
                response_deserializer=notification__pb2.DeleteNotificationResponse.FromString,
                _registered_method=True)
...
def add_NotificationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'DeleteNotification': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=notification__pb2.GetNotificationRequest.FromString,
                    response_serializer=notification__pb2.DeleteNotificationResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'notificationPackage.NotificationService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('notificationPackage.NotificationService', rpc_method_handlers)
...
class NotificationService(object):
    ...
    def DeleteNotification(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/notificationPackage.NotificationService/DeleteNotification',
            notification__pb2.GetNotificationRequest.SerializeToString,
            notification__pb2.DeleteNotificationResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
