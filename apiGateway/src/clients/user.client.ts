...
const UserClient = new userGrpcObject.userPackage.UserService(`${network}:${USER_SERVICE_PORT}`, grpc.credentials.createInsecure());
const AuthClient = new userGrpcObject.userPackage.AuthService(`${network}:${USER_SERVICE_PORT}`, grpc.credentials.createInsecure());
