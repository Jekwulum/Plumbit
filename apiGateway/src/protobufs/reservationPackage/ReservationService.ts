...
import type { EmptyResponse as _reservationPackage_EmptyResponse, EmptyResponse__Output as _reservationPackage_EmptyResponse__Output } from '../reservationPackage/EmptyResponse';
...
export interface ReservationServiceClient extends grpc.Client {
  ...
  DeleteReservation(argument: _reservationPackage_DeleteReservationRequest, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_reservationPackage_EmptyResponse__Output>): grpc.ClientUnaryCall;
  DeleteReservation(argument: _reservationPackage_DeleteReservationRequest, metadata: grpc.Metadata, callback: grpc.requestCallback<_reservationPackage_EmptyResponse__Output>): grpc.ClientUnaryCall;
  DeleteReservation(argument: _reservationPackage_DeleteReservationRequest, options: grpc.CallOptions, callback: grpc.requestCallback<_reservationPackage_EmptyResponse__Output>): grpc.ClientUnaryCall;
  DeleteReservation(argument: _reservationPackage_DeleteReservationRequest, callback: grpc.requestCallback<_reservationPackage_EmptyResponse__Output>): grpc.ClientUnaryCall;
  deleteReservation(argument: _reservationPackage_DeleteReservationRequest, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_reservationPackage_EmptyResponse__Output>): grpc.ClientUnaryCall;
  deleteReservation(argument: _reservationPackage_DeleteReservationRequest, metadata: grpc.Metadata, callback: grpc.requestCallback<_reservationPackage_EmptyResponse__Output>): grpc.ClientUnaryCall;
  deleteReservation(argument: _reservationPackage_DeleteReservationRequest, options: grpc.CallOptions, callback: grpc.requestCallback<_reservationPackage_EmptyResponse__Output>): grpc.ClientUnaryCall;
  deleteReservation(argument: _reservationPackage_DeleteReservationRequest, callback: grpc.requestCallback<_reservationPackage_EmptyResponse__Output>): grpc.ClientUnaryCall;
...
export interface ReservationServiceHandlers extends grpc.UntypedServiceImplementation {
  ...
  DeleteReservation: grpc.handleUnaryCall<_reservationPackage_DeleteReservationRequest__Output, _reservationPackage_EmptyResponse>;
...
export interface ReservationServiceDefinition extends grpc.ServiceDefinition {
  ...
  DeleteReservation: MethodDefinition<_reservationPackage_DeleteReservationRequest, _reservationPackage_EmptyResponse, _reservationPackage_DeleteReservationRequest__Output, _reservationPackage_EmptyResponse__Output>
